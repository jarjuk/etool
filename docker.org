* ~etool~ Docker
  ...
  :header-args+: :var  ETOOL_DOCKER_TAG="6"
  :END:
...
#+RESULTS:
#+begin_example
Sending build context to Docker daemon  608.3kB
...
Step 29/30 : ENTRYPOINT [ "etool.sh" ]
 ---> Running in 1a4645a84b1e
Removing intermediate container 1a4645a84b1e
 ---> b47e6abebe5e
Step 30/30 : CMD [ "usage"]
 ---> Running in 3a311e61e397
Removing intermediate container 3a311e61e397
 ---> 0cb4c1d9565f
Successfully built 0cb4c1d9565f
Successfully tagged marcus2002/etool:6
0
#+end_example
